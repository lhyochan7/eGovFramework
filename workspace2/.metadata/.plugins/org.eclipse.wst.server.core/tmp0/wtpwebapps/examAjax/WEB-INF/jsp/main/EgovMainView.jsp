...
<body>
<script type="text/javascript" src="<c:url value='/js/EgovMainView.js' />"></script>
<form id="frm" method="get" action="<c:url value='/cmm/main/mainPage.do' />" >
    <input type="hidden" id="reqType" name="reqType" value="test"/>
</form>
			...
			<div class="board_wrap">
				...
				<div class="notice_area">
    				...
    				<div class="notice_area">
    					...
    					<a href="#" onclick="javascript:fn_getSubmit(); return false;" class="more"><img src="<c:url value='/images/index/btn_more.gif' />" alt="more" /></a>
    					<!-- 
